...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-950 via-emerald-900 to-blue-950 text-white relative overflow-hidden">
...
//             <Badge
//               variant="outline"
//               className="mb-4 border-emerald-500 text-lg md:text-xl text-emerald-400 animate-pulse"
//             >
...
//               initial={{ scale: 0.95, opacity: 0 }}
//               animate={{ scale: 1, opacity: 1 }}
//               className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-600 leading-tight"
//             >
//               Reinventing Fresh Produce<br className="hidden md:block" /> 
//               <span className="text-emerald-400">Supply Chains</span>
//             </motion.h1>
...
//                          transition-all hover:scale-105 shadow-lg shadow-emerald-500/30"
//               >
//                 <Zap className="mr-2 h-5 w-5" />
//                 Join Network
//               </Button>
...
//                 variant="outline"
//                 size="lg"
//                 className="border-emerald-500 text-emerald-500 hover:bg-emerald-500 hover:text-white hover:border-black rounded-full px-8 py-6 text-lg transition-all hover:scale-105"
//                 >
...
//             className="space-y-16"
//           >
//             <h2 className="text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-600">
...
//                   className="h-full"
//                 >
//                   <Card className="bg-gray-800/50 border-gray-700 hover:border-emerald-500 transition-all group h-full flex flex-col">
//                     <CardContent className="p-6 flex-1 flex flex-col">
//                       <div className="flex items-start gap-4 flex-1">
...
//               <p className="text-gray-400 text-lg">
//                 Stakeaker-governed network with incentive-aligned:
//               </p>
...
//               initial={{ x: 50 }}
//               whileInView={{ x: 0 }}
//               className="bg-gray-800 p-6 rounded-xl border border-emerald-500/20"
//             >
//               <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="h-full"
                >
                  <Card className="bg-gray-800/50 border-gray-700 hover:border-blue-500 transition-all group h-full flex flex-col">
                    <CardContent className="p-6 flex-1 flex flex-col">
                      <div className="flex items-start gap-4 flex-1">
